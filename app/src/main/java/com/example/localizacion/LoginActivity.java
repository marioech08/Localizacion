...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(v -> {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, Constantes.URL_LOGIN,
                    response -> {
                        try {
                    ...
                    error -> {
                        ...
                        Toast.makeText(this, "Error en conexión: " + error.toString(), Toast.LENGTH_LONG).show();
                    }
            ) {
                @Override
